...
import { addToCart, deleteCart, getAllCarts, getUserCart, updateCart } from "../controllers/cart-controller";
...
cartRouter.get("/get-user-cart/:userId", verifyTokenAndAuthorization, getUserCart);
